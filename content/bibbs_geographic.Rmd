...
## BiBBS person level geographic information {#bibbs_geographic_bibbs_geog_person}


```{r echo=FALSE}
dl_types <- c('Variable detail', 'Variable names')
dl_csvs <- c('
bibbs_geographic_bibbs_geog_person
_variables_meta.csv', '
bibbs_geographic_bibbs_geog_person
_variables_names.csv')
make_download_table(dl_types, dl_csvs)
...
## BiBBS property level geographic information {#bibbs_geographic_bibbs_geog_property}


```{r echo=FALSE}
dl_types <- c('Variable detail', 'Variable names')
dl_csvs <- c('
bibbs_geographic_bibbs_geog_property
_variables_meta.csv', '
bibbs_geographic_bibbs_geog_property
_variables_names.csv')
make_download_table(dl_types, dl_csvs)
...
## BiBBS LSOA level geographic information {#bibbs_geographic_bibbs_geog_lsoa}


```{r echo=FALSE}
dl_types <- c('Variable detail', 'Variable names')
dl_csvs <- c('
bibbs_geographic_bibbs_geog_lsoa
_variables_meta.csv', '
bibbs_geographic_bibbs_geog_lsoa
_variables_names.csv')
make_download_table(dl_types, dl_csvs)
