---
params:
  project_name: BiB4All_Geographic
---
...
## BiB4All person level geographic information {#bib4all_geographic_bib4all_geog_person}


```{r echo=FALSE}
dl_types <- c('Variable detail', 'Variable names')
dl_csvs <- c('
bib4all_geographic_bib4all_geog_person
_variables_meta.csv', '
bib4all_geographic_bib4all_geog_person
_variables_names.csv')
make_download_table(dl_types, dl_csvs)
...
```{r, include=FALSE}
tab_id <- 'BiB4All_Geographic.bib4all_geog_person'
prj_name <- 'BiB4All_Geographic'
...
## BiB4All property level geographic information {#bib4all_geographic_bib4all_geog_property}


```{r echo=FALSE}
dl_types <- c('Variable detail', 'Variable names')
dl_csvs <- c('
bib4all_geographic_bib4all_geog_property
_variables_meta.csv', '
bib4all_geographic_bib4all_geog_property
_variables_names.csv')
make_download_table(dl_types, dl_csvs)
...
```{r, include=FALSE}
tab_id <- 'BiB4All_Geographic.bib4all_geog_property'
prj_name <- 'BiB4All_Geographic'
source('../R/make_table_info_display.R', local = knitr::knit_global())
```
...
## BiB4All LSOA level geographic information {#bib4all_geographic_bib4all_geog_lsoa}


```{r echo=FALSE}
dl_types <- c('Variable detail', 'Variable names')
dl_csvs <- c('
bib4all_geographic_bib4all_geog_lsoa
_variables_meta.csv', '
bib4all_geographic_bib4all_geog_lsoa
_variables_names.csv')
make_download_table(dl_types, dl_csvs)
...
```{r, include=FALSE}
tab_id <- 'BiB4All_Geographic.bib4all_geog_lsoa'
prj_name <- 'BiB4All_Geographic'
source('../R/make_table_info_display.R', local = knitr::knit_global())
```
